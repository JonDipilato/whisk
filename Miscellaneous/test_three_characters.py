"""Test scene with all 3 characters: Narrator, Grandmother, and Miso in kitchen."""
...
# Scene: All three characters together in the kitchen
scene = Scene(
    scene_id=303,
    environment_id="kitchen_01",
    character_ids=["narrator_01", "grandmother_01", "miso_01"],  # All 3!
...
print("Three-character scene added: Narrator + Grandmother + Miso!")
